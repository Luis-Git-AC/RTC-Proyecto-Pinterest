...
1. Configuración inicial del proyecto y estructura base de carpetas
2. Obtención y config de la API de Unsplash
3. Creación del archivo .env para almacenar la API key
4. Creación de los componentes y estructura del DOM
...
Importa y ejecuta Header e ImageGrid
Controla la carga inicial de imágenes
Gestiona las búsquedas y fallbacks
Muestra mensajes de error/éxito

main.js — Punto de entrada
Inicializa la aplicación
Carga todos los estilos CSS
Espera a que el DOM esté listo
Ejecuta App() para iniciar la aplicación
